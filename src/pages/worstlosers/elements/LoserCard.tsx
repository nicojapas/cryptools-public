...
interface LoserCardProps extends Coin {
	index: number;
}

const LoserCard = (props: LoserCardProps) => {
			...
			>
				{props.id === null ? (
					...
					<CardActionArea
						...
						onClick={handleClick}
						aria-label={`View ${props.name} (${props.symbol}) chart - Rank #${props.index + 1} loser with ${props.price_change_percentage_24h !== undefined ? props.price_change_percentage_24h.toFixed(2) + "%" : "no"} change`}
					>
						<Stack
							direction="column"
							sx={{
